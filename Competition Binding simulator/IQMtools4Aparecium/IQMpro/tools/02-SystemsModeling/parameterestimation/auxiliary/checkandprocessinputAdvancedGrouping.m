...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [model,experiments,parametersAdvancedGrouping,initialconditions,optimization,costfunction,estimation,experimentmeasurementweights] = checkandprocessinputAdvancedGrouping(project,projectstruct,estimation)
...
% CHECK advanced grouping parameter names
parametersAdvancedGrouping = {};
