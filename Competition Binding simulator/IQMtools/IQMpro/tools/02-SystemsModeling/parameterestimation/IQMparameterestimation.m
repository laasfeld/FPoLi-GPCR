...
% GLOBAL VARIABLES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% estimation.experiments.measurementindices = cell(1, 1);
% estimation.experiments.measurementweight = cell(2,1);
% estimation.experiments.measurementindices = cell(2, 1);
% estimation.experiments.measurementweight{1}{1} = rand(74, 2);
% estimation.experiments.measurementweight{2}{1} = rand(74, 2);
% estimation.experiments.measurementindices{1} = 1;
% estimation.experiments.measurementindices{2} = 1;
