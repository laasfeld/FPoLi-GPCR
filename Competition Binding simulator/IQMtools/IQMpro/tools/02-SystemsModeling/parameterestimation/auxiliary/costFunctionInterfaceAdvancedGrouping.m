...
if optimizerboundsFlag == 1,
    parameterValuesAdvanced = X(1:numel(parametersAdvancedGrouping.names));
    icvalues = X(numel(parameterValuesAdvanced)+1:end);
else
...
for k=1:length(workestimation),
    ...
    indicesInAdvancedParamVector = workestimation(k).indicesInAdvancedParamVector;
    pv = parameterValuesAdvanced(indicesInAdvancedParamVector);
