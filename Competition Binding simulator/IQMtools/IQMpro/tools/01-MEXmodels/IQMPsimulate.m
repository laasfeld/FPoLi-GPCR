...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[uniqueTimeVector, ~,reverseMap] = unique(timevector);
%simdata = feval(MEXmodel,timevector,ICs,paramvec,OPTIONS);
simdata = feval(MEXmodel,uniqueTimeVector,ICs,paramvec,OPTIONS);

%restore original times
simdata.time = simdata.time(:, reverseMap);
simdata.statevalues = simdata.statevalues(reverseMap, :);
simdata.variablevalues = simdata.variablevalues(reverseMap, :);
simdata.reactionvalues = simdata.reactionvalues(reverseMap, :);
